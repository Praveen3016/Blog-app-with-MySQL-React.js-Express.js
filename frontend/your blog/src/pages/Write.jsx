...
const navigate = useNavigate();
  ...
  const handleClick = async (e) => {
    ...
    try {
      state 
      ? await axios.put(`http://localhost:8888/api/posts/${state.id}` , {
        title ,
        desc:value,
        cat ,
        img : file ? imgURL : "",
    ...
    <div className='add'>
      <div className="content">
        ...
        <div className="editorContainer">
          <ReactQuill className='editor' style={{ scrollbarColor: "white" }} theme="snow" value={value } onChange={setValue} />;
        </div>
      </div>
      <div className="menu">
        <div className="item">
